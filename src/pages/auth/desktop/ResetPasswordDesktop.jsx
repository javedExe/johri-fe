  ...
  return (
    <main className="h-screen flex w-full overflow-hidden">
      ...
      <section className="flex flex-col p-10 w-[50vw] min-h-screen mx-6">
        ...
        <div className="border-[1px] border-purple-200 bg-purple-50 bg-opacity-50 rounded-3xl px-10 py-15 mt-2 justify-center">
          <IoMdLock className="bg-purple-100 text-4xl font-bold border-none rounded-full text-purple-700 mb-2 p-2" />
          <h2 className="text-4xl font-medium">Create New Password</h2>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="bg-black text-white rounded font-medium text-sm p-2 py-3 mt-4 w-full transition-all duration-150 active:scale-98 ease-in-out disabled:bg-gray-500 disabled:cursor-not-allowed disabled:opacity-50"
            >
